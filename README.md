...
This is the main page for my book "Deep Learning Algorithms", now in PyTorch
...
* Check out the folder "SecondEdition" for all corresponding new resources in PyTorch.
